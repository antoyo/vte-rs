...
impl Terminal {
    ...
    //#[cfg(feature = "v0_46")]
    //pub fn event_check_regex_simple(&self, event: /*Ignored*/&mut gdk::Event, regexes: &[&Regex], match_flags: u32, matches: /*Unimplemented*/Vec<String>) -> Option</*Unimplemented*/Fundamental: Size> {
    //    unsafe { TODO: call ffi::vte_terminal_event_check_regex_simple() }
    //}

    //pub fn feed(&self, data: /*Unimplemented*/Option<&CArray TypeId { ns_id: 0, id: 3 }>, length: /*Unimplemented*/Fundamental: SSize) {
    //    unsafe { TODO: call ffi::vte_terminal_feed() }
    //}

    //pub fn feed_child<'a, T: Into<Option<&'a str>>>(&self, text: T, length: /*Unimplemented*/Fundamental: SSize) {
    //    unsafe { TODO: call ffi::vte_terminal_feed_child() }
    //}

    //pub fn feed_child_binary(&self, data: /*Unimplemented*/Option<&CArray TypeId { ns_id: 0, id: 3 }>, length: /*Unimplemented*/Fundamental: Size) {
    ...
    #[cfg(feature = "v0_46")]
    pub fn match_add_regex(&self, regex: &Regex, flags: u32) -> i32 {
        unsafe {
            ffi::vte_terminal_match_add_regex(self.to_glib_none().0, regex.to_glib_none().0, flags)
        }
    }
    ...
    #[cfg(feature = "v0_46")]
    pub fn search_get_regex(&self) -> Option<Regex> {
        unsafe {
            from_glib_none(ffi::vte_terminal_search_get_regex(self.to_glib_none().0))
        }
    }
    ...
    #[cfg(feature = "v0_46")]
    pub fn search_set_regex(&self, regex: Option<&Regex>, flags: u32) {
        unsafe {
            ffi::vte_terminal_search_set_regex(self.to_glib_none().0, regex.to_glib_none().0, flags);
        }
    }
    ...
    pub fn set_encoding<'a, T: Into<Option<&'a str>>>(&self, codeset: T) -> Result<(), Error> {
        unsafe {
            let mut error = ptr::null_mut();
            let _ = ffi::vte_terminal_set_encoding(self.to_glib_none().0, codeset.into().to_glib_none().0, &mut error);
    ...
    //#[cfg(feature = "v0_48")]
    //pub fn spawn_async<'a, T: Into<Option<&'a str>>>(&self, pty_flags: PtyFlags, working_directory: T, argv: &[&std::path::Path], envv: &[&std::path::Path], spawn_flags_: /*Ignored*/glib::SpawnFlags, child_setup: /*Unknown conversion*//*Unimplemented*/SpawnChildSetupFunc, child_setup_data: /*Unimplemented*/Option<Fundamental: Pointer>, child_setup_data_destroy: /*Unknown conversion*//*Unimplemented*/DestroyNotify, timeout: i32, cancellable: /*Ignored*/Option<&gio::Cancellable>, callback: /*Unknown conversion*//*Unimplemented*/TerminalSpawnAsyncCallback, user_data: /*Unimplemented*/Option<Fundamental: Pointer>) {
    //    unsafe { TODO: call ffi::vte_terminal_spawn_async() }
    //}

    //pub fn spawn_sync<'a, T: Into<Option<&'a str>>>(&self, pty_flags: PtyFlags, working_directory: T, argv: &[&std::path::Path], envv: &[&std::path::Path], spawn_flags: /*Ignored*/glib::SpawnFlags, child_setup: /*Unknown conversion*//*Unimplemented*/SpawnChildSetupFunc, child_setup_data: /*Unimplemented*/Option<Fundamental: Pointer>, cancellable: /*Ignored*/Option<&gio::Cancellable>) -> Result</*Ignored*/glib::Pid, Error> {
    ...
    pub fn get_property_backspace_binding(&self) -> EraseBinding {
    ...
    pub fn get_property_delete_binding(&self) -> EraseBinding {
        let mut value = Value::from(&0);
        unsafe {
    ...
    /*pub fn set_property_font_desc(&self, font_desc: Option<&pango::FontDescription>) {
        unsafe {
            gobject_ffi::g_object_set_property(self.to_glib_none().0, "font-desc".to_glib_none().0, Value::from(font_desc).to_glib_none().0);
        }
    }*/

    pub fn get_property_pointer_autohide(&self) -> bool {
    ...
    pub fn set_property_pointer_autohide(&self, pointer_autohide: bool) {
        unsafe {
    ...
    pub fn get_property_scroll_on_keystroke(&self) -> bool {
        let mut value = Value::from(&false);
        unsafe {
    ...
    pub fn get_property_scroll_on_output(&self) -> bool {
        let mut value = Value::from(&false);
        unsafe {
    ...
    pub fn get_property_scrollback_lines(&self) -> u32 {
